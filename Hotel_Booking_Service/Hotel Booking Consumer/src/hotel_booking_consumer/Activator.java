...
//				System.out.println();
				...
				while(true) {
					...
					System.out.println("========================================================================");
					System.out.println("Choose a Hotel to continue:");
					System.out.println("     1. Rathna Pearl Grand");
					System.out.println("     2. Mandarina Colombo");
					System.out.println();
					System.out.print("Enter the Hotel (Enter the number):");
					hotel = sobj.nextInt();
					System.out.println();
				...
				if(hotel == 1) {
					...
					hotelName = "Rathna Pearl Grand";
					hotelAddress = "09 Edward Ln, Colombo 00003";
					hotelTelephone = "0112 597 444";
					...
					hotelAddress = "433 A2, Colombo 00300";
					hotelTelephone = "0112 550 660";
				}
